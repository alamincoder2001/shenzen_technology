            ...
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: totalCashIn > 0 ? '' : 'none'}">
                            <?php echo $this->session->userdata('Currency_Name'); ?> {{ totalCashIn | decimal }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: totalCashOut > 0 ? '' : 'none'}">
                            <?php echo $this->session->userdata('Currency_Name'); ?> {{ totalCashOut | decimal }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="account-section">
                    ...
                    <div class="col2">
                        ...
                        <h3 style="display:none;" v-bind:style="{display: cashBalance == 0 ? 'none' : ''}">
                            <?php echo $this->session->userdata('Currency_Name'); ?> {{ cashBalance | decimal }}</h3>
                    </div>
                </div>
            </div>
        </div>
