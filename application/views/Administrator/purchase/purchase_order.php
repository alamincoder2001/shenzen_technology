    ...
    new Vue({
        ...
        methods: {
            ...
            addToCart() {
                ...
                let cartInd = this.cart.findIndex(p => p.productId == this.selectedProduct.Product_SlNo && p.productId != 'P01');
                if (cartInd > -1) {
            ...
            calculateTotal() {
                ...
                this.purchase.total = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) +
                    parseFloat(this.purchase.freight)) - parseFloat(this.purchase.discount)).toFixed(2);
            ...
            savePurchase() {
                ...
                this.purchase.account_id = this.account.account_id
